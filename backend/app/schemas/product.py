...
class ProductUpdate(BaseModel):
    ...
    codigo_principal: Optional[str] = Field(
        None,
        min_length=1,
        max_length=50,
        description="Código principal del producto (SKU)",
    ...
    iva_codigo: Optional[str] = Field(
        None,
        max_length=2,
        description="Código de tarifa de IVA",
    )
    iva_porcentaje: Optional[Decimal] = Field(
        None,
        ge=0,
...
class ProductResponse(BaseModel):
    ...
    ubicacion: Optional[str] = Field(None, description="Ubicación física en bodega")
